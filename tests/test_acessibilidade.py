...
def test_pagina_tem_exatamente_um_h1_visivel(page, live_server, rota):
    ...
    REGRAS declara acima (a régua global do projeto, que não mexemos aqui).
    Sem esta asserção própria, remover o <h1> de uma página não seria pego
    por nenhum teste desta suíte."""
    page.goto(f"{live_server.url}{rota}")
